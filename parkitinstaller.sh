...
echo "Changing to user asterisk" && sudo su - asterisk -c "echo 'Creating virtual environment myenv'" && sudo python3 -m venv /home/asterisk/myenv && echo "Installing flask and pyst2" && source /home/asterisk/myenv/bin/activate && pip install flask pyst2 asterisk &&  pip install --upgrade pip && deactivate
...
[Service]
ExecStart=/var/lib/asterisk/scripts/parkit11.py
